...
<body>
    ...
    <form class="form_search" action="buscar_venta.php" method="get">
        ...
        <input type="text" name="busqueda" id="busquueda" placeholder="No. factura">
    ...
    //paginador
    $sql_registro = mysqli_query($conection, "SELECT COUNT(*) as total_registros FROM `factura` WHERE estado != 10");

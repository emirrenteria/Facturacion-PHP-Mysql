...
<body>
   ...
   ?>
    ...
    //paginador
    $sql_registro = mysqli_query($conection, "SELECT COUNT(*) as total_registros FROM `producto` 
                                                                                 WHERE ( cod_product LIKE '%$busqueda%' OR
    ...
    $query = mysqli_query($conection, "SELECT cod_product, nombre, descripcion, cant_product, precio_product, unidad_com 
                                            FROM producto
                                            WHERE  
                                                 (cod_product LIKE '%$busqueda%' OR
                                                  nombre LIKE '%$busqueda%'
                                                  )
                                            AND estado = 1
